...
namespace MaxCinema.Migrations
{
    ...
    [Migration("20241119130518_Order OrderRowe Conected")]
    partial class OrderOrderRoweConected
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaxCinema.Models.OrderRow", b =>
                {
                    b.HasOne("MaxCinema.Models.Movie", "Movie")
                        .WithMany("OrdeRows")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MaxCinema.Models.Order", "Order")
